...
git config --global alias.rom '!git fetch && git rebase --interactive "origin/$(git default-branch)"'
git config --global alias.rum '!git fetch && git rebase --interactive "upstream/$(git default-branch)"'
